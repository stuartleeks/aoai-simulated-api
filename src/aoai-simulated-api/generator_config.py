...
# See src/example_generator_config/generator_config.py for an example of how to define your own generators
...
def get_generators() -> list[Callable[[Request], Response | None]]:
    ...
    return [
        lambda request: Response(
            content="Default generated response - see src/example_generator_config/generator_config.py for example generator code",
            status_code=200,
        ),
    ]
